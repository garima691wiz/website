...
export const middleList = [
    ...
    listItem: [
      {
        _id: "002",
        listData: [
          "Sell products on distinct",
          "Sell on distinct Business",
          "Sell apps on distinct",
          "Become an Affiliate",
          "Advertise Your Products",
          "Sell Product with Us",
          "Host an distinct Hub",
  ...
  {
    _id: 2223,
    title: "distinct Payment Products",
    listItem: [
      {
        _id: "003",
        listData: [
          "distinct Business Card",
          "Shop with Points",
          "Reload Your Balance",
          "distinct Currency Converter",
        ],
      },
    ],
  },
...
export const footerBottomItem = [
  ...
  },
  {
    _id: 1003,
    title: "Careers",
    des: "Cloud storage from distinct",
  },
  {
    _id: 1004,
    title: "Our Company",
